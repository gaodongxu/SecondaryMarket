...
ArrayList<Goods> gdsList = new ArrayList<>();
    ...
    PreparedStatement pstmt = conn.prepareStatement("select goods.gdsid,gdsimg,gdsname,gdsprice,clsfcname,state from goods,classification,consumption"
                                         +" where goods.gdsclsfcid=classification.clsfcid and goods.gdsid=consumption.gdsid and consumption.username=?");
...
<!-- right -->
  <ul class="layui-nav layui-nav-tree user" lay-filter="demo">
    ...
    <li class="layui-nav-item"><a id="mainpage" href="mainpage.jsp?username=">商城主页</a></li>
...
function getUsername(){
	...
	$("#mainpage").attr("href",$("#mainpage").attr("href")+username);
}
getUsername();
function balance(){
	<%
